...
class TestProductCategoryImageInputDeltaDoFn():
    def test_process(self):
        ...
        previous_product_dtls_tag = ProductCategoryImageTransformDoFn.process('ddd', (oms_id, details))
        ...
        current_product_dtls_tag = ProductCategoryImageTransformDoFn.process('ddd',(oms_id,details))
        ...
        assert ProductCategoryImageInputDeltaDoFn.process("ddd",(oms_id,element)) == current_product_dtls_tag