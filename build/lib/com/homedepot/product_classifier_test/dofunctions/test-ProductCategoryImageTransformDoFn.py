...
class TestProductCategoryImageTransformDoFn():
    def test_process(self):
        (oms_id, details) = ('100000001',{'product_category_dtls_tag':[['036d1251-c31e-4f5a-95dc-89b0242ae1e5','036d1251-c31e-4f5a-95dc-89b0242ae1e6']],
        ...
        ProductCategoryImageTransformDoFn.process('data',(oms_id,details))
        assert Exception